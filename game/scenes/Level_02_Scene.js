...
class Level_02_Scene extends Scene {
    ...
    start() {
        ...
        this.addGameObject(new BulletGameObject1("Bullet Game Object",), 30, 250, 20)
        this.addGameObject(new BulletGameObject2("Bullet Game Object",), 250, 30, 20)
        ...
        this.addGameObject(new GameObject().addComponent(new MainSceneController(Level_01_Scene)))
    }
}