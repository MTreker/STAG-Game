...
class Level_03_Scene extends Scene {
    ...
    start() {
        ...
        this.addGameObject(new GuardGameObject2("Guard Game Object", 30, 5), 250, 30, 20)
        ...
        this.addGameObject(new GameObject().addComponent(new Text("black", "30px Times New Roman", "Level: 3")), 79,-20)
