...
class Level_05_Scene extends Scene {

    start() {
        this.addGameObject(new PlayerGameObject("Player Game Object"), 300, 300, 20)
        this.addGameObject(new GuardGameObject1("Guard Game Object", 50, 25), 30, 250, 20)
        this.addGameObject(new GuardGameObject2("Guard Game Object", 10, 5), 250, 30, 20)
        ...
        this.addGameObject(new GameObject().addComponent(new Text("black", "30px Times New Roman", "Level: 5")), 79,-20)
